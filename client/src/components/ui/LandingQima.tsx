...
export default function LandingQima() {
        ...
        <div className="items-start gap-3.5 text-center md:flex">
          <div className="mb-8 flex flex-1 flex-col gap-3.5 md:mb-auto">
            ...
            <ul className="m-auto flex w-full flex-col gap-3.5 sm:max-w-md">
              ...
              >
                &quot;{localize('com_ui_example_inspection')}&quot; →
              </button>
              <button
                onClick={clickHandler}
                className="w-full rounded-md bg-gray-50 p-3 hover:bg-gray-200 dark:bg-white/5 dark:hover:bg-gray-900"
              >
                &quot;{localize('com_ui_example_food_email')}&quot; →
              </button>
              <button
                onClick={clickHandler}
                className="w-full rounded-md bg-gray-50 p-3 hover:bg-gray-200 dark:bg-white/5 dark:hover:bg-gray-900"
              >
                &quot;{localize('com_ui_example_report')}&quot; →
              </button>
            </ul>
          </div>
          <div className="mb-8 flex flex-1 flex-col gap-3.5 md:mb-auto">
          ...
          <div className="mb-8 flex flex-1 flex-col gap-3.5 md:mb-auto">
            ...
            <ul className="m-auto flex w-full flex-col gap-3.5 sm:max-w-md">
              ...
              <li className="w-full rounded-md bg-gray-50 p-3 dark:bg-white/5">
                {localize('com_ui_limitation_limited_qima')}
              </li>
            </ul>
          </div>
        </div>
